...
import com.example.projectapp.ChecklistJsonClass.Campi;
import com.example.projectapp.ChecklistJsonClass.Checklist;
import com.example.projectapp.ChecklistJsonClass.Chiavi_valori;
import com.example.projectapp.ChecklistJsonClass.Transizioni;
import com.example.projectapp.Singleton.GsonSingleton;
import com.example.projectapp.Singleton.VolleySingleton;
            ...
            invioRicezioneJson(URL[0], toJsonObject(jsonBase), new JsonResponseListener() {
                ...
                public void onResponse(JSONObject response) {
                    ...
                    if (jsonfail.getEsito().getErrore()==0){
                        ...
                        elementiLinearLayout = new LinearLayout(MainActivity.this);
                        ...
                        for (int i = 0; i < campi.size(); i++) {
                            ...
                            esito = jsonBase.getEsito().getErrore();
                            if (esito == 0){
                                generateElemento(MainActivity.this, listaElementi, campi.get(i), elementiLinearLayout);
                            }else {
                                Toast.makeText(MainActivity.this, "errore: "+jsonBase.getEsito().getDescrizione(), Toast.LENGTH_LONG).show();
                            }
                        ...
                        transizioniLinearLayout = new LinearLayout(MainActivity.this);
                        ...
                        Toast.makeText(MainActivity.this, "ErroreJson: " + jsonfail.getEsito().getDescrizione(), Toast.LENGTH_SHORT).show();
                    }
                ...
                public void onError(VolleyError e) {
                    e.printStackTrace();
                    Toast.makeText(MainActivity.this, "volley error, perche ESITO : "+ jsonBase.getEsito().getDescrizione(), Toast.LENGTH_LONG).show();
                }
            });
        }
        else {
                ...
                raccoglitoreTransizioni(URL, jsonBase, listaTransizioni.get(i), listaElementi, new JsonResponseListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        if (esito == 0){
                            ...
                            Toast.makeText(MainActivity.this, "ErroreJson: " + jsonBase.getEsito().getDescrizione(), Toast.LENGTH_SHORT).show();
                        }
            ...
            btnListaContenitori.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (!etListaContenitori.getText().toString().isEmpty()){
                        ...
                        Campi elementoNuovo = MainActivity.jsonBase.getPasso().getCampi().get(id);
                        elementoNuovo.setValore("");
                        elementoNuovo.setValore(etListaContenitori.getText().toString());


                        invioRicezioneJson(elemento.getUrlverifica(), toJsonObject(MainActivity.jsonBase), new JsonResponseListener() {
                            @Override
                            public void onResponse(JSONObject response) {
                                Checklist json = null;
...
//                            Il for è necesario perche racoglie le info quando avviene il onclick, attenzione con il jsonbase che verra modificato
                        ...
                        public void onError(VolleyError e) {
                            ...
                            Toast.makeText(MainActivity.this, "No ha funzionato el boton", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            });
    ...
    public void onFailureEvent(BarcodeFailureEvent barcodeFailureEvent) {
        Toast.makeText(this, "Scanner non ha riconosciuto il barcode", Toast.LENGTH_SHORT).show();
    }
